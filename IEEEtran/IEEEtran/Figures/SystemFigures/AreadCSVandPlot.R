...
pdf("/Users/arghyakusumdas/Documents/MyGitProjects/MyIeeeAccessPaper/IEEEtran/IEEEtran/Figures/SystemFigures/WordCountIO.pdf", family="Times")

#Read data from CSV
data <- read.csv(file="WordCountIO.csv",head=FALSE,sep=",")
