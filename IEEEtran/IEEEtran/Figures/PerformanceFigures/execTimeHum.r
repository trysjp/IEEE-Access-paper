...
barplot(as.matrix(data), add=TRUE, main="", ylim=c(0, 1.3), xlab="Applications",ylab="Execution time normalized to SuperMikeII Baseline", names=c("Graph Construction", "Graph Simplification"), col=c("black","blue", "red"), beside=TRUE, density=20, angle=c(45,90,45), cex.lab=1.5, cex.axis=1.3, cex.names=1)
